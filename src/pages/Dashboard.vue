      ...
      <div class="statistics-container" ref="statCardsRef">
        <div class="stat-card">
          <div class="stat-header">
            <div class="title-container" :class="['stat-title', { 'no-series': !bomix.getSeriesInfo().value.name }]">
...
<script setup>
  ...
  function calculateTableHeight() {
    ...
    const availableHeight = windowHeight - headerHeight - pageHeaderHeight * 2 - statCardsHeight.value;
